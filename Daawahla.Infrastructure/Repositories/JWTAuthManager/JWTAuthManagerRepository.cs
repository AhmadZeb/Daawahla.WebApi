...
namespace Daawahla.Infrastructure.Repositories.JWTAuthManager
{
    public class JWTAuthManagerRepository : IJWTAuthManager
    {
        private readonly IConfiguration _configuration;

        public JWTAuthManagerRepository(IConfiguration configuration)
        {
        ...
        public Response<List<T>> getUserList<T>()
        {
            ...
            string query = "Select userid,username,email,[role],reg_date FROM users";
